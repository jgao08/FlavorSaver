...
final class RecipeTests: XCTestCase {
    ...
    func testExample() async throws {
        ...
        let stepsWithIngredientsTruth = [("In a large heavy-bottomed French or Dutch oven, heat the oil over medium high heat.", ["cooking oil"]), ("Add the garlic and shallots and gently saute for 3-5 minutes, stirring constantly until fragrant and translucent. Lower the heat if the garlic starts to brown.", ["2 shallots, minced", "2 garlic cloves, minced"]), ("Add the piment dEspelette or red pepper flakes, if using.", ["1/4 teaspoon piment d\'Espelette or crushed red pepper flakes, optional"]), ("Pour in the vodka and let reduce by half, another 3-5 minutes.", ["1/2 cup vodka"]), ("Add in the tomatoes and a sprinkling of salt. Bring to a boil and let simmer, uncovered, stirring often to break up the tomatoes, until sauce is thick, about 15 minutes.", ["28 ounce can whole, peeled tomatoes (See the Guide)", "sauce", "salt and freshly ground black pepper, to taste"]), ("Meanwhile, bring a large stockpot of water to a boil over high heat. Once the water boils, salt the water and cook penne until just under al dente, about 9 minutes and then drain in a colander.", ["1 pound penne", "water", "salt and freshly ground black pepper, to taste"]), ("While the pasta cooks, stir cream into the thickened tomato sauce. Bring to a boil and lower heat to a simmer. Season again with salt and pepper to taste.", ["salt and pepper", "tomato sauce", "cup heavy cream", "pasta"]), ("Add the drained pasta to the tomato sauce and stir to coat the pasta with the sauce. The sauce should be thick enough to coat the pasta; continue to stir and reduce if needed.", ["tomato sauce", "pasta", "sauce"]), ("Turn off the heat and sprinkle Parmigiano-Reggiano over the pasta and toss to coat evenly.", ["parmigiano reggiano", "pasta"]), ("Just before serving, thinly slice or tear up the basil leaves. Divide pasta among 4 serving platters.", ["1/4 cup loosely packed fresh basil leaves", "pasta"]), ("Garnish with a sprinkling of Parmigiano-Reggiano and basil.", ["parmigiano reggiano", "1/4 cup loosely packed fresh basil leaves"])]
        ...
        for (left, right) in zip(result.getRecipeStepsWithAmounts(), stepsWithIngredientsTruth){
            XCTAssert(left == right)
        }
    }
